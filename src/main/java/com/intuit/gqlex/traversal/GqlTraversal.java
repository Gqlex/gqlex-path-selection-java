...
public class GqlTraversal {
    ...
    private TuneableTraversal tuneableTraversal;
    ...
    public void traverse(String queryString, TuneableTraversal tuneableTraversal) {
        Preconditions.checkNotNull(queryString);

        Document graphQL = parseDocument(queryString);

        traverse(graphQL, tuneableTraversal);
    }
    public void traverse(Node queryNode, TuneableTraversal tuneableTraversal) {

        this.tuneableTraversal = tuneableTraversal;
    ...
    private void traverseDefinition(Definition definition, Node parentNode) {
        ...
        try {
            ...
            if (definition instanceof OperationDefinition) {
                ...
                if( this.tuneableTraversal != null ){
                    isBrowse = this.tuneableTraversal.isContainsFragment();
                }
    ...
    private void traverseFragmentDefinition(FragmentDefinition fragmentDefinition, Node parentNode) {
        ...
        try {
            ...
            if( this.tuneableTraversal != null ){
                isBrowse = this.tuneableTraversal.isContainsDirectives();
            }
    ...
    private void traverseOperationDefinition(OperationDefinition operationDefinition, Node parentNode) {
        ...
        try {
            ...
            if( this.tuneableTraversal != null ){
                isBrowse = this.tuneableTraversal.isContainsVariables();
            }
    ...
    private void traverseDirective(Directive directive, Node parentNode) {
        try {
            ...
            if( this.tuneableTraversal != null ){
                isBrowse = this.tuneableTraversal.isContainsArgument();
            }
